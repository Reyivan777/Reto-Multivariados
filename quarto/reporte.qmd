...
Se utilizó una red neuronal artificial feedforward como uno de los modelos de predicción de O3. La metodología se planteó en base al trabajo de Cifuentes et al. (2021) ya que les resultó con mucho éxito. 
...
importancia_variables |>
  ...
  labs(
    ...
    x = "Variable",
    y = "Incremento en RMSE al permutar"
  ) +
  theme_minimal()
