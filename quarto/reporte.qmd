...
En esta sección estandarizamos ciertas variables continuas para que se aproximen en una media 0 y desviación estándar 1. Esto por si queremos hacer un PCA, KNN, SVM, etc. Si no, mantenemos los valores continuos ("datos_modelo").
