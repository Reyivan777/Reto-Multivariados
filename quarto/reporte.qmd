...
**Datos duplicados**\
Se verificó la existencia de registros duplicados a nivel de Año, Estación y fecha y hora mediante un conteo de combinaciones repetidas (`duplicados`). El resultado confirmó que, conceptualmente, no existen registros duplicados en la base bajo este criterio.
