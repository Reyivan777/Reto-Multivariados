...
El modelo para h = 1 explica el 86.2 % de la devianza de O3 (R² ajustado = 0.861), usando siete smooths meteorológicos/temporales más efectos paramétricos de estación y dirección del viento, sobre un conjunto de 39,043 casos completos (86.6 % de los objetivos disponibles).

**Concurvity** La mayoría de los smooths presenta concurvity moderada (0.42-0.66), esperable por la covariación natural entre variables meteorológicas. El rezago de 24 horas de O3 destaca con 0.963, ya que comparte con la hora del día la misma periodicidad diurna; se conserva por ser significativo (p \< 0.001), aunque su forma exacta debe interpretarse con cautela.
...
Herramienta: ChatGPT, Claude (Anthropic) y otras herramientas de IA utilizadas por el equipo durante el desarrollo.
