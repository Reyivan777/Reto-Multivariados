...
La media, mediana y moda describen la tendencia central de las mediciones, mientras que el rango, la varianza y la desviación estándar permiten evaluar su dispersión. Los cuartiles Q1 y Q3 se conservan porque servirán como referencia para el análisis de distribución y valores atípicos de la siguiente sección.

Debido a que varias de las variables analizadas son continuas, la moda debe interpretarse con cautela: representa el valor observado con mayor frecuencia y puede depender de la precisión con la que se registran las mediciones.
