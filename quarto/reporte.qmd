...
datos_extremos <- datos_base_modelado |>
  select(Año, all_of(variables_medicion)) |>
  pivot_longer(
...
En este punto todavía no se modifica `datos_base_modelado`. Los resultados de estas tablas se revisarán antes de decidir cuáles valores deben convertirse a `NA` y cuáles deben conservarse como extremos válidos.
