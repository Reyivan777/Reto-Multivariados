...
En esta reconstrucción se parte nuevamente de los archivos originales `BD 2020.xlsx` a `BD 2025.xlsx`. El archivo `datos_etapa2_limpios.csv`, generado durante la entrega anterior, se conserva en el repositorio como antecedente, pero no se utiliza como punto de partida del nuevo flujo. De esta forma, todas las decisiones de limpieza y transformación quedan reproducibles desde los datos originales.
...
Pendiente de revisar la estructura resultante de `datos_brutos`, homologar las diferencias entre años y cuantificar la disponibilidad de O3 y de sus posibles predictores.

## Selección del subconjunto de trabajo

Pendiente de justificar y validar formalmente la selección de `NTE`, `NTE2`, `NO` y `NE` para el modelado de O3.
