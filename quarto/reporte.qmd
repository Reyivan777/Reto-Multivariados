...
En `datos_tipos` las mediciones ya pueden utilizarse para cálculos estadísticos. Los valores faltantes, banderas de medición y valores fuera de rango todavía no se corrigen en este paso; se revisan por separado a continuación.
