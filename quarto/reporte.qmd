...
Este diagnóstico todavía no selecciona los rezagos definitivos ni construye las variables objetivo futuras. Primero se revisará cómo disminuye o se recupera la correlación a lo largo de las 24 horas y si el patrón es consistente entre estaciones. A partir de esos resultados se decidirá qué rezagos del propio O3 vale la pena conservar antes de repetir el análisis con las variables meteorológicas y contaminantes más prometedoras.
