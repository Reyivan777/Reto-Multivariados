...
La interpretación de la dirección del viento se realizará después de ejecutar esta tabla y figura. Con ello quedará cerrada la revisión inicial de meteorología antes de pasar a las asociaciones entre O3 y los demás contaminantes.

### Otros contaminantes

Pendiente de analizar `CO`, `NO`, `NO2`, `NOX`, `PM10`, `PM2.5` y `SO2` y comparar su asociación con O3.
