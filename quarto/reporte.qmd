...
Los tres bloques más largos ocurren al inicio de 2021: `NO` no registra O3 durante 1,536 horas, `NTE` durante 1,296 y `NE` durante 1,284 horas. Esto explica una parte importante de los porcentajes elevados de faltantes observados en 2021. Después de ese periodo todavía aparecen interrupciones largas, pero son menos extensas; por ejemplo, se observan bloques de 218 horas en `NTE` durante 2023 y de 163 horas en `NO` durante 2024.
