...
En este punto todavía no se modifica `datos_base_modelado`. Después de revisar esta última tabla se decidirá el tratamiento de los valores fuera de rango y se construirá la base limpia para continuar con las variables temporales y el análisis exploratorio.
