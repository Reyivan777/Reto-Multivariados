...
La interpretación se realizará después de ejecutar estos resultados. En particular, se revisará si `NO`, `NO2` y `NOX`, que fueron los contaminantes contemporáneos más relacionados con O3, mantienen información útil en horizontes futuros y si su posible aporte compensa sus porcentajes elevados de valores faltantes.
