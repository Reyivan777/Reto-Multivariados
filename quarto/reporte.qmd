...
Finalmente se calcula la media y la mediana de O3 para cada hora del día. Esta revisión permitirá identificar si existe una estructura diaria suficientemente marcada como para justificar el uso de variables horarias en el modelo.
...
La interpretación de estas tablas y figuras se realizará con los resultados obtenidos al ejecutar el reporte antes de continuar con los patrones mensuales y la relación de O3 con las variables meteorológicas.
