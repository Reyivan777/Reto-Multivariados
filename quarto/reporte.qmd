...
Esta comparación se utilizará para decidir el alcance horario del problema antes de continuar con el modelado. No se fija todavía una ventana diurna de manera arbitraria: primero se revisará si las horas de baja concentración nocturna y las horas de mayor actividad diurna se mantienen en años distintos. Si se decide restringir el objetivo a un intervalo diurno, la disponibilidad de casos completos de la base formal se volverá a calcular para ese conjunto de horas.
