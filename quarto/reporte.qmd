...
Esta tabla constituye la última comprobación antes de fijar el tratamiento de los faltantes en los predictores. El O3 objetivo seguirá sin imputarse. Si la cobertura mediante casos completos continúa siendo baja, especialmente en validación o prueba, será necesario definir una estrategia para los predictores antes de ajustar los modelos. `NOX` seguirá evaluándose por separado para comprobar si su aporte compensa la pérdida adicional de observaciones.
